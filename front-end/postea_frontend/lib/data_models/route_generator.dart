...
import 'package:postea_frontend/pages/tempPage.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/home':
        ...
        // });
        return MaterialPageRoute(
            builder: (_) => HomePage(profileID: args.profileID)); // do homepage
      case '/devpage':
        return MaterialPageRoute(builder: (_) => DevPage()); // do DevPage
      case '/error':
        return MaterialPageRoute(builder: (_) => ErrorPage()); // do errorPage
