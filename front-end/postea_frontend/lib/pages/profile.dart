...
class _ProfileState extends State<Profile> {
  ...
  getAllPostsWithEngagements() async {
    var url = "http://postea-server.herokuapp.com/getAllPostsWithEngagement?profile_id=" + widget.profileId.toString();
  ...
  Future getSavedPosts() async {
    ProcessSavePost processSavePost = new ProcessSavePost(profile_id: widget.myPID.toString());
  ...
  Future<http.Response> getUserPosts(int profile_id) async {
    var url = "http://postea-server.herokuapp.com/getAllUserPosts?profile_id=" + widget.profileId.toString();
                              ...
                              transitionsBuilder: (context, animation, secondaryAnimation, child) {
                                return FadeTransition(
                                  ...
                                  position: Tween<Offset>(
                                    begin: Offset(0, -1),
                                    end: Offset(0, 0)).animate(CurvedAnimation(parent: animation, curve: Curves.decelerate)),
                                    child: child,
                                  )
                                );
                              },
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        GestureDetector(
                                          onTap: isPrivate && !widget.isOwner && !isFollow ? null : () {
                                            Navigator.push(context, MaterialPageRoute(builder: (_) => FollowerList(profileId: widget.profileId, name: name,))).then((value) => setState(() {}));
                                          },
                                          child: Text(
                                            "Followers",
                                            style: TextStyle(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        GestureDetector(
                                          onTap: isPrivate && !widget.isOwner && !isFollow ? null : () {
                                            Navigator.push(context, MaterialPageRoute(builder: (_) => FollowingList(profileId: widget.profileId, name: name,))).then((value) => setState(() {}));
                                          },
                                          child: Text(
                                            "Following",
                                            style: TextStyle(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (isFollow) {
                                        ...
                                        final request = http.Request(
                                          "DELETE",
                                          Uri.parse("http://postea-server.herokuapp.com/followdata"),
                                        );
                                    ...
                                    children: <Widget>[
                                      ...
                                      Card(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(child: Text(bio_data),),
                                        ),
                                      ),
                                      Row(
                                        children: [
                                            ...
                                            child: FutureBuilder(
                                              ...
                                              builder: (context, snapshot) {
                                                if (snapshot.hasData) {
                                                  ...
                                                  if (snapshot.data == "No post made by this user") {
                                                    return Center(
                                                    ...
                                                    return ListView.builder(
                                                      ...
                                                      itemBuilder: (context, index) {
                                                        return PostTile(
                                                          ...
                                                          postMap[index]['post_title'].toString(),
                                                          name.toString(),
                                                          profileId.toString(),
                                                          false,
