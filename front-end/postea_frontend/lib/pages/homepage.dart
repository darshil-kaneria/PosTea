...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver {
  ...
  getUserData() async {
    http.get(
      "http://postea-server.herokuapp.com/getUserInfo?profile_id=" + widget.profileID.toString(),
      headers: {
  ...
  getFollowingList() async {
    ...
    http.Response response = await http.get(
      "http://postea-server.herokuapp.com/getFollowingTopics?profile_id=" + widget.profileID.toString(),
      headers: {
        HttpHeaders.authorizationHeader: "Bearer posteaadmin",
      },
    );
  ...
  Future uploadImage(File file) async {
    StorageReference storageReference = FirebaseStorage.instance.ref().child("post").child(postID.toString());
  ...
  void makePost() async {
    ...
    http.post(
      "http://postea-server.herokuapp.com/post",
      headers: {
  ...
  initializeWebSocket() async {
    webSocketChannel = IOWebSocketChannel.connect("ws://postea-server.herokuapp.com");
      ...
      children: [
        Scaffold(
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () async {
                    Navigator.push(context, MaterialPageRoute(builder: (_) => CreateTopic(profile_id: widget.profileID,)));
                  },
                ),
                ListTile(
          ...
          bottomNavigationBar: CustomNavBar(
            ...
            onTap: (value) {
              if (value == 2) {
                Navigator.push(context, MaterialPageRoute(builder: (_) => Trending(profileId: widget.profileID, isAccessibilityOn: pref.getInt("accessibility") == 1)));
              } else if (value == 4) {
                Navigator.push(context, MaterialPageRoute(builder: (_) => ExploreTopics()));
              } else if (value == 1)
                // Making a post logic
                showDialog(
                  context: context,
                                    ...
                                    child: Column(
                                      children: [
                                        TextField(
                                          ...
                                          decoration: InputDecoration(border: InputBorder.none, hintText: "Post description",),
                                                    ...
                                                    if (snapshot.hasData) {
                                                      ...
                                                      return Container(
                                                        ...
                                                        itemBuilder: (context, index) {
                                                          return ListTile(
                                                            onTap: () {
                                                              String currPostDesc = postTextController.text;
                                                              int indexOfAt = currPostDesc.indexOf("@");
                                                              if (followingData[index]['username'] != null) {
                                                                if (indexOfAt == currPostDesc.length -1) {
                                                                  postTextController.text = postTextController.text + followingData[index]['username'];
                                                                  } else {
                                                                    postTextController.text = postTextController.text.replaceFirst(
                                                                      currPostDesc.substring(indexOfAt + 1, currPostDesc.length),
                                                                      followingData[index]['username']
                                                                    );
                                                                  }
                                                                } else {
                                                                  if (indexOfAt == currPostDesc.length - 1) {
                                                                    postTextController.text = postTextController.text + followingData[index]['topic_name'];
                                                                  } else {
                                                                    postTextController.text = postTextController.text.replaceFirst(
                                                                      currPostDesc.substring(indexOfAt + 1, currPostDesc.length),
                                                                      followingData[index]['topic_name']
                                                                    );
                                                                  }
                                                                }
                                                              },
                                                              leading: FutureBuilder(
                                                                future: followingData[index]['profile_id'] == null ? FirebaseStorageService.getImage(
                                                                  context,
                                                                  followingData[index]['topic_id'].toString(),
                                                                )
                                                                : FirebaseStorageService.getImage(
                                                                  context,
                                                                  followingData[index]['profile_id'].toString(),
                                                                ),
                                                                builder: (context, AsyncSnapshot<dynamic> snapshot) {
                                                                  if (snapshot.hasData) {
                                                                    return CircleAvatar(
                                                                      backgroundImage: NetworkImage(snapshot.data),
                                                                      maxRadius: screenWidth / 25,
                                                                    );
                                                                  } else {
                                                                    return CircleAvatar(
                                                                      maxRadius: screenWidth / 25,
                                                              ...
                                                              title: followingData[index]['username'] == null ? Text(
                                                                followingData[index]['topic_name'],
                                                              ...
                                                              subtitle: followingData[index]['username'] == null ? Text(
                                                                "Topic",
                                                      ...
                                                      return Center(
                                                        child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation(bgGradEnd),),
                                                      );
                                                    }
                                                  },
                                                );
                                            ...
                                            return IconButton(
                                              ...
                                              onPressed: () {
                                                if (isAnonymous.value == 0) {
                                                  isAnonymous.value = 1;
                                                  isAnonColor.value = Colors.deepOrange[100];
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  TextField(
                                                                    ...
                                                                    decoration: InputDecoration(border: InputBorder.none, hintText: "Enter a topic",),
                                                                  ),
                                                                  ButtonTheme(
                                                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                                                                    child: RaisedButton(
                    ...
                    child: Container(
                      ...
                      child: ValueListenableBuilder(
                        ...
                        builder: (_, value, __) {
                          if (value > 0) {
                            return FutureBuilder(
                              future: getSearchResults(searchTextController.text),
                              builder: (BuildContext context, AsyncSnapshot<http.Response> snapshot) {
                                if (snapshot.hasData) {
                                  List searchResults = jsonDecode(snapshot.data.body);
                                  print(searchResults);
                                  print("len of search results is " + searchResults.length.toString());
                                  return Material(
                                    color: Theme.of(context).canvasColor,
                                    child: ListView.builder(
                                      physics: BouncingScrollPhysics(),
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        print("dict at index is " + searchResults[index].toString());
                                        if (searchResults[index] != null) {
                                          if (searchResults[index]['type'] == "profile") {
                                            return ListTile(
                                              onTap: () {
                                                if (searchResults[index]['profile_id'] == widget.profileID) {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Profile(profileId: searchResults[index]['profile_id'], isOwner: true,),),);
                                                } else {
                                                  Navigator.push(context, MaterialPageRoute(builder: (context) => Profile(profileId: searchResults[index]['profile_id'], isOwner: false,),),);
                                                }
                                              },
                                              leading: FutureBuilder(
                                                future: FirebaseStorageService.getImage(
                                                  context,
                                                  searchResults[index]['profile_id'].toString()
                                                ),
                                                builder: (context, snapshot) {
                                                  if (snapshot.hasData) {
                                                    return CircleAvatar(
                                              ...
                                              subtitle: Text(
                                                searchResults[index]['type'].toString(),
                                            ...
                                            return ListTile(
                                              onTap: () {
                                                ...
                                                if (topicIDList.contains(
                                                  searchResults[index]['topic_id'].toString())) {
                                                  Navigator.push(
                                                    context,
                                                    MaterialPageRoute(
                                                      builder: (context) => Topic(
                                                      profileId: widget.profileID,
                                                      topicId: searchResults[index]['topic_id'],
                                                      isOwner: true,
                                                    ),
                                                  ),
                                                );
                                              } else {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => Topic(profileId: widget.profileID, topicId: searchResults[index]['topic_id'], isOwner: false,),),);
                                              }
                                            },
                                            leading: FutureBuilder(
                                            ...
                                            title: Text(
                                              searchResults[index]['topic_name'].toString(),
                                              style: Theme.of(context).textTheme.headline1
                                            ),
                                            subtitle: Text(
                                              searchResults[index]['type'].toString(),
                ...
                child: Material(
                  child: Row(
                    children: [
                      ...
                      Text("Notifications", style: Theme.of(context).textTheme.headline4),
                    ],
                  ),
                ),
              ),
                    ...
                    child: ValueListenableBuilder(
                      ...
                      builder: (context, value, child) {
                        return Container(
                          ...
                          child: notifList.length == 0 ? Center(
                            child: Container(
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  onTap: () async {
                                    if (notifList[index]['postID'] != null) {
                                      var postData = await getPost(notifList[index]['postID'].toString());
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => ExpandedPostTile(
                                            postData[0]['post_id'].toString(),
                                            postData[0]['profile_id'].toString(),
                                            postData[0]['post_description'].toString(),
                                            postData[0]['topic_id'].toString(),
                                            postData[0]['post_img'].toString(),
                                            postData[0]['creation_date'].toString(),
                                            postData[0]['post_likes'].toString(),
                                            postData[0]['post_dislikes'].toString(),
                                            postData[0]['post_comments'].toString(),
                                            postData[0]['post_title'].toString(),
                                            postData[0]['name'].toString(),
                                            postData[0]['myPID'].toString(),
                                            postData[0]['is_sensitive'],
                                            postData[0]['isAccessibilityOn'].toString(),
                                          ),
                                        ),
                                      );
                                    } else {
                                      if (notifList[index]['engagement'].toString().contains("following")) {
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => Profile( profileId: int.parse(notifList[index]['senderID'],), isOwner: false,),),);
                                      }
                                    }
                                  },
                                  leading: FutureBuilder(
