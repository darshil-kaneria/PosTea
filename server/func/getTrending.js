    ...
    return new Promise(async (resolve, reject) => {
        ...
        await connection.query({ sql: getEngLastHour, timeout: 120000 }, async (err, result) => {
            ...
            if (finalList.length == 1) {
                finalListString = finalList[0]['postId'];
                query = `SELECT * FROM user_post as up, profile as p WHERE up.post_id in (${finalListString}) and up.profile_id = p.profile_id ORDER BY FIELD(up.post_id, ${finalListString})`;
            ...
            console.log("final list string is " + finalListString)
